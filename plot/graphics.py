...
class EyeSampleTracePlot(pg.PlotWidget):
    def __init__(self,time_series, parent=None, background='default', color_pallete=None, add_legend=False, **kwargs):
        pg.PlotWidget.__init__(self, parent, background, **kwargs)
        self.init(time_series,color_pallete,add_legend)

    def init(self,time_series, color_pallete=None, add_legend=False):
...
# 'suffix': 's', 'siPrefix': True
    ...
    def enableRegion(self, initial_bounds, update_callback = lambda x: x, associated_plot = None, zvalue = 10):
        ...
        return self.initRegion(initial_bounds, update_callback, associated_plot , zvalue )
    ...
    def initRegion(self,initial_bounds, update_callback = lambda x: x, associated_plot = None, zvalue = 10):
        ...
        self._region.sigRegionChanged.connect(self.updateRG)
    ...
    def setRegionAssociation(self, region):
        ...
        self.sigRangeChanged.connect(self.updateRegion)
    ...
    def enableMouseCrossHairs(self, mousemove_callback):
        ...
        self._mmproxy = pg.SignalProxy(self.scene().sigMouseMoved, rateLimit=60, slot=self.mouseMoved)
...
class DataStats(pg.DataTreeWidget):
    def __init__(self):
        self._stat_resources = None#data_region_plot

        self.indexFromTime = None#data_region_plot._time_series.indexFromTime
    ...
    def init(self,  data_region_plot, data_source):
